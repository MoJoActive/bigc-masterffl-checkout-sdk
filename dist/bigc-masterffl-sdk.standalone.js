(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MasterFFLStandalone = {}));
  ...
  const MasterFFLContext = reactExports.createContext({});
  const useMasterFFL = () => {
    const context = reactExports.useContext(MasterFFLContext);
    if (!context) {
      throw new Error("useMasterFFL must be used within a MasterFFLProvider");
    }
    return context;
  };
  const MasterFFLProvider = ({ children }) => {
    const [isModalOpen, setIsModalOpen] = reactExports.useState(false);
    const [values, setValues] = reactExports.useState({
      postalCode: "",
      acceptTerms: false
    });
    const [selectedDealer, setSelectedDealer] = reactExports.useState(null);
    const [error, setError] = reactExports.useState(null);
    const [isFFL, setIsFFL] = reactExports.useState(false);
    const [isSuppressor, setIsSuppressor] = reactExports.useState(false);
    const handleInit = async () => {
      const { postalCode, acceptTerms, selectedDealer: selectedDealer2 } = SDK.getSession(SDK.getConfig().checkoutId);
    ...
    const providerValues = reactExports.useMemo(() => {
      return {
        isModalOpen,
        setIsModalOpen,
        values,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MasterFFLContext.Provider, { value: providerValues, children });
  };
  const MasterFFL = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(MasterFFLProvider, { children: [
  ...
  const MasterFFLModal = () => {
    ...
    const dealerSelectionCallback = async (selectedDealer) => {
      ...
      Object.keys(address).forEach((key) => {
        const input = document.querySelector(`[name="shippingAddress.${key}"]`);
        if (input) {
          const nextValue = String(address[key] ?? "");
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: SELECTOR_ID, className: "ffl-modal-body", style: { height: "100%", flex: 1 } })
            }
          )
        }
      )
  ...
  const MasterFFLForm = () => {
    ...
    const [errors, setErrors] = reactExports.useState({ postalCode: "", acceptTerms: "" });
    const observerRef = reactExports.useRef(null);
    const buttonRef = reactExports.useRef(null);
    const billingObserverRef = reactExports.useRef(null);
    const acceptTermsRef = reactExports.useRef(false);
    const selectedDealerRef = reactExports.useRef(false);
    reactExports.useEffect(() => {
    ...
    const applyBillingSameAsShipping = reactExports.useCallback(() => {
      const billingSameAsShipping = document.querySelector('input[type="checkbox"][name="billingSameAsShipping"]');
    ...
    const applyDisabledState = reactExports.useCallback(() => {
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `form-field ${errors.postalCode ? "form-field--error" : ""}`, style: { flex: 1, marginBottom: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { fontSize: 18, margin: "0 0 15px 0" }, children: SDK.getConfig().lang.heading }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontWeight: 600 }, children: SDK.getConfig().lang.subheading }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "form-label optimizedCheckout-form-label", htmlFor: "postalCode", children: [
                  SDK.getConfig().lang.postalCodeLabel,
                  " ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "row", alignItems: "center", gap: 10 }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleSubmit, style: { margin: 0 }, className: "button button--primary optimizedCheckout-buttonPrimary", children: SDK.getConfig().lang.buttonText }) })
                ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `form-field-agreement form-field ${errors.acceptTerms ? "form-field--error" : ""}`, style: { marginTop: 15 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label optimizedCheckout-form-label", htmlFor: "accept-agreement", children: SDK.getConfig().lang.termsLabel }),
          ...
          selectedDealer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 15 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: SDK.getConfig().lang.selectedDealerLabel }),
  ...
  const renderMasterFFL = () => {
    window.__masterfflScriptManager = window.__masterfflScriptManager || {};
    if (window.__masterfflScriptManager.initialized) return;
    window.__masterfflScriptManager.initialized = true;
    ...
    const mountIfReady = () => {
      ...
      if (!app._root) {
        ...
        app._root = root;
        root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(MasterFFL, {}));
      }
      return true;
    };
    mountIfReady();
    let rafScheduled = false;
    const observer = window.__masterfflScriptManager.observer || new MutationObserver(() => {
    ...
    window.__masterfflScriptManager.observer = observer;
    observer.observe(document.body, { childList: true, subtree: true });
  };
  renderMasterFFL();

  exports.renderMasterFFL = renderMasterFFL;

  Object.defineProperty(exports, Symbol.toStringTag, { value: 'Module' });

}));
//# sourceMappingURL=bigc-masterffl-sdk.standalone.js.map
